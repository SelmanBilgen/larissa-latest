...
import restaurantOutside from "../assets/bereket-dis.jpg";
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center text-white">
          <motion.h1
            ...
            style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8), 2px 2px 8px rgba(0, 0, 0, 0.8)' }}
          >
            {t.about.title}
          </motion.h1>
          <motion.p
